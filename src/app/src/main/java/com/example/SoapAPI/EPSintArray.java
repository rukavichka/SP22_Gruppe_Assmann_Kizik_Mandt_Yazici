...
public class EPSintArray extends Vector<Integer> implements KvmSerializable,HasAttributes
{
    ...
    public EPSintArray(int initialCapactiy)
    {
        super(initialCapactiy);
    }

    public EPSintArray(java.util.Collection< Integer> initialCapactiy)
    {
        super(initialCapactiy);
    }
