...
public class SEDExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    static {
        classNames.put("urn:ilUserAdministration^^ilUserData",SEDilUserData.class);
        classNames.put("urn:ilUserAdministration^^ilOperation",SEDilOperation.class);
        classNames.put("urn:ilUserAdministration^^intArray",SEDintArray.class);
        classNames.put("urn:ilUserAdministration^^stringArray",SEDstringArray.class);
        classNames.put("urn:ilUserAdministration^^doubleArray",SEDdoubleArray.class);
        classNames.put("urn:ilUserAdministration^^ilOperations",SEDilOperations.class);
    } 
    ...
    public static void setDateTimeConverter(SEDDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new SEDStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static SEDDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static SEDDateTimeConverter dateTimeConverter = new SEDStandardDateTimeConverter();

    public SEDExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public SEDExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new SEDMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=SEDHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    public SoapObject GetSoapObject(Element detailElement) {
        ...
        catch (java.lang.Exception e)
        {
			if(enableLogging)
			{
				android.util.Log.e(SEDExtendedSoapSerializationEnvelope.TAG,"Error occured",e);
			}
        }
        return null;
    }
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,SEDExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=SEDHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
