...
public class SEDstringArray extends Vector<String> implements KvmSerializable,HasAttributes
{
    private transient java.lang.Object __source;

    public SEDstringArray()
    {
    }

    public SEDstringArray(int initialCapactiy)
    {
        super(initialCapactiy);
    }

    public SEDstringArray(java.util.Collection< String> initialCapactiy)
    {
        super(initialCapactiy);
    }
