...
public class SEDintArray extends Vector<Integer> implements KvmSerializable,HasAttributes
{
    ...
    public SEDintArray(int initialCapactiy)
    {
        super(initialCapactiy);
    }

    public SEDintArray(java.util.Collection< Integer> initialCapactiy)
    {
        super(initialCapactiy);
    }
