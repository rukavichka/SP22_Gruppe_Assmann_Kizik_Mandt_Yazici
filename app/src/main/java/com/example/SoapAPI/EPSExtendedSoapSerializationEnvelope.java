...
public class EPSExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    static {
        classNames.put("urn:ilUserAdministration^^ilUserData",EPSilUserData.class);
        classNames.put("urn:ilUserAdministration^^ilOperation",EPSilOperation.class);
        classNames.put("urn:ilUserAdministration^^intArray",EPSintArray.class);
        classNames.put("urn:ilUserAdministration^^stringArray",EPSstringArray.class);
        classNames.put("urn:ilUserAdministration^^doubleArray",EPSdoubleArray.class);
        classNames.put("urn:ilUserAdministration^^ilOperations",EPSilOperations.class);
    } 
    ...
    public static void setDateTimeConverter(EPSDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new EPSStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static EPSDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static EPSDateTimeConverter dateTimeConverter = new EPSStandardDateTimeConverter();

    public EPSExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public EPSExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new EPSMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=EPSHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    public SoapObject GetSoapObject(Element detailElement) {
        ...
        catch (java.lang.Exception e)
        {
			if(enableLogging)
			{
				android.util.Log.e(EPSExtendedSoapSerializationEnvelope.TAG,"Error occured",e);
			}
        }
        return null;
    }
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,EPSExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=EPSHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
