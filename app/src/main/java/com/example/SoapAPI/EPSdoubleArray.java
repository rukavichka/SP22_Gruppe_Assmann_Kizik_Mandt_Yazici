...
public class EPSdoubleArray extends Vector<Double> implements KvmSerializable,HasAttributes
{
    private transient java.lang.Object __source;

    public EPSdoubleArray()
    {
    }

    public EPSdoubleArray(int initialCapactiy)
    {
        super(initialCapactiy);
    }

    public EPSdoubleArray(java.util.Collection< Double> initialCapactiy)
    {
        super(initialCapactiy);
    }
